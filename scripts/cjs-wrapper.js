...
// Compute relative path from output dir to source using path.relative()
// (string replace is fragile and generates absolute paths for non-adjacent dirs)
const outputDir = dirname(resolve(process.cwd(), output))
const sourceAbs = resolve(process.cwd(), source)
let relativePath = relative(outputDir, sourceAbs)
if (!relativePath.startsWith('.')) relativePath = './' + relativePath
// Remove .js extension for require() (Node.js resolves it automatically)
