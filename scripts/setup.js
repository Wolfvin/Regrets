...
if (dryRun) {
  ...
  for (const stack of manifestStacks) {
    if (stack === 'js' || stack === 'ts') {
      ...
      console.log('   Would run: bash scripts/capture_bash.sh')
    }
  }
  ...
  for (const stack of manifestStacks) {
    if (stack === 'js' || stack === 'ts') {
      ...
      captureOk = runVisible('bash', [`${SCRIPTS_DIR}/capture_bash.sh`]) && captureOk
    }
  }
...
if (dryRun) {
  ...
  for (const stack of manifestStacks) {
    if (stack === 'js' || stack === 'ts' || stack === 'react') {
      ...
      console.log('   Would run: bash scripts/validate_bash.sh')
    }
  }
  ...
  for (const stack of manifestStacks) {
    if (stack === 'js' || stack === 'ts' || stack === 'react') {
      ...
      validateOk = runVisible('bash', [`${SCRIPTS_DIR}/validate_bash.sh`]) && validateOk
    }
  }
