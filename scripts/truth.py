...
# Mirrors truth.js for Python clusters.
#
...
def main():
    ...
    for cluster in python_clusters:
        ...
        try:
            ...
            for input_val in inputs:
                ...
                output_for_record = apply_output_transform(deep_clone(raw_output), output_transform)
    ...
    try:
        ...
        for fname in regret_files:
            ...
            # Extract golden output from data section
            golden_output = None
            sections = content.split('\n---\n')
            if len(sections) > 1:
                ...
                for line in data_section.split('\n'):
                    if line.startswith('OUTPUT '):
                        output_str = line[7:]  # len("OUTPUT ") = 7
                        try:
