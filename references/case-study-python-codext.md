...
def vigenere_encode(text):
    # Note: codext requires a key suffix for vigenere, e.g. "vigenere-key"
    # A bare "vigenere" encoding name will raise LookupError
    return codext.encode(text, "vigenere-key")
