/**
 * environment.js — Rockstar execution environment
 *
 * Refactored from the original monolithic file:
 * - Equality logic extracted to equality.js
 * - Binary operations extracted to operators.js
     ...
     for (let i = 0; i < list.length; i++) {
         ...
         switch (type) {
             ...
             case "listen":
                 return env.readline();
             case "binary":
                 return operators.binary(expr, evaluate, env);
             case "lookup":
